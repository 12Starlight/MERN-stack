// Although there's only one function here so far, let us import the whole file, since we will be adding more later
...
// Upon login, set session token and dispatch the current user. Dispatch errors on failure
